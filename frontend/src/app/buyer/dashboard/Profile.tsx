                            ...
                            < div className="grid grid-cols-1 md:grid-cols-2 gap-4" >
                                <div className="md:col-span-2" >
                                    ...
                                    < input
                                        ...
                                        onChange={(e) => setProfileForm({
                                            ...profileForm,
                                            street: { ...profileForm.street, street: e.target.value }
                                        })}
                                    />
                                </div>
                                ...
                                < div >
                                    ...
                                    < input
                                        ...
                                        onChange={(e) => setProfileForm({
                                            ...profileForm,
                                            city: { ...profileForm, city: e.target.value }
                                        })}
                                    />
                                </div>
                                ...
                                < div >
                                    ...
                                    < input
                                        ...
                                        onChange={(e) => setProfileForm({
                                            ...profileForm,
                                            state: { ...profileForm, state: e.target.value }
                                        })}
                                    />
                                </div>
                                ...
                                < div >
                                    ...
                                    < input
                                        ...
                                        onChange={(e) => setProfileForm({
                                            ...profileForm,
                                            zipCode: { ...profileForm, zipCode: e.target.value }
                                        })}
                                    />
                                </div>
                                ...
                                < div >
                                    ...
                                    < input
                                        ...
                                        onChange={(e) => setProfileForm({
                                            ...profileForm,
                                            country: { ...profileForm, country: e.target.value }
                                        })}
                                    />
                                </div>
                            </div>
