...
export default function RequestCertificationButton({ 
  ...
  const handleRequest = async () => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(errorData.message || "Failed to request certification");
      }
      ...
      const payRes = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/certification/paypal/create`, {
        ...
        headers: { "Content-Type": "application/json" },
        credentials: "include",
        body: JSON.stringify({ certificationId: responseData.id }),
      });
      ...
      console.error("Certification request error:", e);
      setError(e.message);
  ...
  const handlePaymentSuccess = async () => {
    setPaid(true);
    // Call the callback again to refresh parent data after payment
    onCertificationRequested?.();
        ...
        <div className="p-6">
          ...
          <div className="grid md:grid-cols-2 gap-6 items-center">
            ...
            <div className="flex flex-col items-center">
              ...
              {requested && !paymentUrl && !paid && !error && (
